...
componentDidMount = () => {
    ...
    /* 	let cityRef = firebase.firestore().collection('contadores')
       .doc('casos');
    ...
    if (!doc.exists) {
      ...
      this.setState({
        casosActivos: doc.data().casosActivos,
        casosDirecta: doc.data()['1-Directa'],
        casosCodusef: doc.data()['2-Condusef'],
        casosJOral: doc.data()['3-Oral'],
        casosJOrdinario: doc.data()['3-Mercantil'],
      })
  ...
  render() {
    console.log('indicadores',this.state)
